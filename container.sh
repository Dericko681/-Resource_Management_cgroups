...
multipass exec $INSTANCE_NAME -- bash -c "sudo apt update && sudo apt install -y docker.io && git clone https://github.com/Dericko681/Resource_Management_cgroups.git && sudo docker pull ubuntu && cd Resource_Management_cgroups"
